...
#   sudo ./scripts/admin-password-reset.sh --email admin@example.test --random
#
#   # Reset to an interactively-typed password (no shell history leak):
#   sudo ./scripts/admin-password-reset.sh --email admin@example.test
#
#   # From operator's workstation with a custom kubeconfig:
#   ./scripts/admin-password-reset.sh --email admin@example.test \
