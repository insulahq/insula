...
RESP=$(api POST "/clients" "{\"name\":\"$COMPANY\",\"primary_email\":\"pvc-l-$STAMP@phoenix-host.net\",\"plan_id\":\"$PLAN_ID\",\"region_id\":\"$REGION_ID\",\"storage_tier\":\"local\"}")
...
RESP=$(api POST "/clients" "{\"name\":\"$COMPANY\",\"primary_email\":\"pvc-race-$STAMP@phoenix-host.net\",\"plan_id\":\"$PLAN_ID\",\"region_id\":\"$REGION_ID\",\"storage_tier\":\"local\"}")
