...
# flow on a real cluster (default: staging1.phoenix-host.net). Covers
# the three 2026-05-28 fixes — domain-scoped lookup, mail.<apex> Domain
# move, and auto-reseed when the principal is missing.
#
# Usage:
#   HOST=root@staging1.phoenix-host.net \
#     PLATFORM_APEX=staging.phoenix-host.net \
...
HOST="${HOST:-root@staging1.phoenix-host.net}"
PLATFORM_APEX="${PLATFORM_APEX:-staging.phoenix-host.net}"
