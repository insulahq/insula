...
TABLES="notifications notification_deliveries notification_rate_limit_buckets notification_template_versions notification_object_mutes notification_digest_items"
...
for field in deliveries notifications buckets templateVersions expiredMutes digestItems; do
