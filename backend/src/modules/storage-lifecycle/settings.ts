...
// Single definition lives in @insula/api-contracts so the admin panel and the
// route validate against the same object.
import { storageLifecycleSettingsSchema } from '@insula/api-contracts';
export { storageLifecycleSettingsSchema };
