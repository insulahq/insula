 ...
 * cluster.phoenix-host.net — not reconstructed. A hand-written fixture would
 ...
 */
const DIRTY_LOG_OUTPUT = "[fsck] fsType=xfs dryRun=true dev=/dev/longhorn/pvc-60dd3bcd-d8d7-4fa2-85c3-e7b7548e3fcf\nPhase 1 - find and verify superblock...\n        - block cache size set to 764408 entries\nPhase 2 - using internal log\n        - zero log...\nzero_log: head block 79392 tail block 79376\nALERT: The filesystem has valuable metadata changes in a log which is being\nignored because the -n option was used.  Expect spurious inconsistencies\nwhich may be resolved by first mounting the filesystem to replay the log.\n        - scan filesystem freespace and inode maps...\nsb_fdblocks 1019986, counted 1052976\n        - found root inode chunk\nPhase 3 - for each AG...\n        - scan (but don't clear) agi unlinked lists...\n        - process known inodes and perform inode discovery...\n        - agno = 0\n        - agno = 1\n        - agno = 2\n        - agno = 3\n        - process newly discovered inodes...\nPhase 4 - check for duplicate blocks...\n        - setting up duplicate extent list...\n        - check for inodes claiming duplicate blocks...\n        - agno = 0\n        - agno = 1\n        - agno = 2\n        - agno = 3\nNo modify flag set, skipping phase 5\nPhase 6 - check inode connectivity...\n        - traversing filesystem ...\n        - agno = 0\n        - agno = 1\n        - agno = 2\n        - agno = 3\n        - traversal finished ...\n        - moving disconnected inodes to lost+found ...\nPhase 7 - verify link counts...\nNo modify flag set, skipping filesystem flush and exiting.\n\n        XFS_REPAIR Summary    Fri Sep 25 21:34:50 2026\n\nPhase\t\tStart\t\tEnd\t\tDuration\nPhase 1:\t09/25 21:34:49\t09/25 21:34:49\t\nPhase 2:\t09/25 21:34:49\t09/25 21:34:49\t\nPhase 3:\t09/25 21:34:49\t09/25 21:34:49\t\nPhase 4:\t09/25 21:34:49\t09/25 21:34:49\t\nPhase 5:\tSkipped\nPhase 6:\t09/25 21:34:49\t09/25 21:34:50\t1 second\nPhase 7:\t09/25 21:34:50\t09/25 21:34:50\t\n\nTotal run time: 1 second\n[fsck] exit=1";

const CLEAN_OUTPUT = "[fsck] fsType=xfs dryRun=true dev=/dev/longhorn/pvc-60dd3bcd-d8d7-4fa2-85c3-e7b7548e3fcf\nPhase 1 - find and verify superblock...\n        - block cache size set to 764408 entries\nPhase 2 - using internal log\n        - zero log...\nzero_log: head block 80208 tail block 80208\n        - scan filesystem freespace and inode maps...\n        - found root inode chunk\nPhase 3 - for each AG...\n        - scan (but don't clear) agi unlinked lists...\n        - process known inodes and perform inode discovery...\n        - agno = 0\n        - agno = 1\n        - agno = 2\n        - agno = 3\n        - process newly discovered inodes...\nPhase 4 - check for duplicate blocks...\n        - setting up duplicate extent list...\n        - check for inodes claiming duplicate blocks...\n        - agno = 0\n        - agno = 1\n        - agno = 3\n        - agno = 2\nNo modify flag set, skipping phase 5\nPhase 6 - check inode connectivity...\n        - traversing filesystem ...\n        - agno = 0\n        - agno = 1\n        - agno = 2\n        - agno = 3\n        - traversal finished ...\n        - moving disconnected inodes to lost+found ...\nPhase 7 - verify link counts...\nNo modify flag set, skipping filesystem flush and exiting.\n\n        XFS_REPAIR Summary    Fri Sep 25 22:24:45 2026\n\nPhase\t\tStart\t\tEnd\t\tDuration\nPhase 1:\t09/25 22:24:44\t09/25 22:24:44\t\nPhase 2:\t09/25 22:24:44\t09/25 22:24:44\t\nPhase 3:\t09/25 22:24:44\t09/25 22:24:45\t1 second\nPhase 4:\t09/25 22:24:45\t09/25 22:24:45\t\nPhase 5:\tSkipped\nPhase 6:\t09/25 22:24:45\t09/25 22:24:45\t\nPhase 7:\t09/25 22:24:45\t09/25 22:24:45\t\n\nTotal run time: 1 second\n[fsck] exit=0";
