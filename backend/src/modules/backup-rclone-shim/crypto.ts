 ...
 */
const HKDF_LABELS = {
  shimAccessKey: 'platform.example.test/backup-rclone-shim/s3-access',
  shimSecretKey: 'platform.example.test/backup-rclone-shim/s3-secret',
  cryptPassword: 'platform.example.test/backup-rclone-shim/crypt-password',
  cryptSalt: 'platform.example.test/backup-rclone-shim/crypt-salt',
} as const;
