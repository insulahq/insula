  ...
  const body: k8s.V1Service = {
    ...
    metadata: {
      ...
      labels: {
        ...
        'platform.phoenix-host.net/tenant-namespace': tenantNamespace,
      },
    },
    spec: {
      type: 'ExternalName',
...
async function reapStaleTunnels(
  ...
  const labelSelector = `platform.phoenix-host.net/private-worker-tunnel=true,platform.phoenix-host.net/tenant-namespace=${tenantNamespace}`;
