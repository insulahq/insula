 ...
 * wrongly.
 */
export const DETACHED_ROUTE_TARGET = { deploymentId: null, siteFolder: null } as const;

/**
 * Returns a copy of `values` with `siteFolder` cleared when the same write
