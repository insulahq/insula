...
const CTR_GVR = { group: 'platform.example.test', version: 'v1alpha1', plural: 'clustertrustedranges' } as const;
const CPP_GVR = { group: 'platform.example.test', version: 'v1alpha1', plural: 'clusterpendingpeers' } as const;
