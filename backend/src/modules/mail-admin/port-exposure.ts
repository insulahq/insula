...
const DS_ENABLED_SELECTOR = { 'platform.example.test/node-role': 'server' } as const;
const DS_DISABLED_SELECTOR = { 'platform.example.test/mail-haproxy-disabled': 'true' } as const;
