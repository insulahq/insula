...
[ADR-036](../architecture/adr/ADR-036-custom-deployments.md); for the
tenant-facing usage guide see
[CUSTOM_CONTAINERS_USER_GUIDE.md](../features/CUSTOM_CONTAINERS_USER_GUIDE.md).
...
- [ADR-036](../architecture/adr/ADR-036-custom-deployments.md) — architectural decisions, threat model, trade-offs
- [CUSTOM_CONTAINERS_USER_GUIDE.md](../features/CUSTOM_CONTAINERS_USER_GUIDE.md) — tenant-facing usage guide
