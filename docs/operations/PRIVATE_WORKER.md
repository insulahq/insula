...
- [ADR-022 — DNS, NetBird, IAM are external](../architecture/adr/ARCHITECTURE_DECISION_RECORDS.md)
- [ADR-025 / ADR-026 — Catalog scope](../architecture/adr/ARCHITECTURE_DECISION_RECORDS.md) (private worker is deliberately *not* a catalog entry)
- [ADR-033 — Tenant lifecycle hook registry](../architecture/adr/ADR-033-tenant-lifecycle-hook-registry.md)
