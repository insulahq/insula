...
> **Bundle format:** [../06-features/BACKUP_COMPONENT_MODEL.md](../architecture/BACKUP_COMPONENT_MODEL.md) (authoritative)
> **Policy:** [BACKUP_STRATEGY.md](../history/02-operations/BACKUP_STRATEGY.md)
> **ADR:** [../07-reference/ADR-028-backup-architecture.md](../architecture/adr/ADR-028-backup-architecture.md)
...
- **Backup issues:** support@k8s-platform.test
- **Migration help:** migration-guide@k8s-platform.test
- **Password recovery:** password-recovery@k8s-platform.test
- **Documentation:** https://docs.k8s-platform.test/backup-migration
