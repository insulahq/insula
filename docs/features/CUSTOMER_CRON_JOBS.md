...
The original migration plan (see roadmap R1) specifies "cron jobs (extracted as scripts)". The automated migration service extracts jobs using:
...
- **Migration plan** (see roadmap R1): Data migration from legacy panels
