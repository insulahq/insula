...
**Status:** Live — platform DB is PostgreSQL (CNPG); Drizzle ORM `backend/src/db/schema.ts` is authoritative
**Last Updated:** 2026-06-07 (restructure pass; verify details against schema.ts)
**Owner:** Platform Team
