...
192.0.2.56 hosting the full stack (k3s control plane, platform-api,
...
This is documented in `docs/architecture/NODE_ROLE_TAXONOMY.md` as a
...
a Cluster CR pointing at the existing Postgres data directory.
