...
The Stalwart mail server uses RocksDB as its data store. Today we have two backup mechanisms (and the BACKUP_ARCHITECTURE_RFC Phase R11 may introduce a third):
