...
| this PR (PR-5) | Integration harness, lifecycle/bundle verification, operator + tenant docs, this ADR. | `scripts/integration-custom-deployments.sh`, `docs/operations/CUSTOM_DEPLOYMENTS.md`, `docs/features/CUSTOM_CONTAINERS_USER_GUIDE.md`, this file |
...
- `docs/operations/CUSTOM_DEPLOYMENTS.md` — operator runbook
- `docs/features/CUSTOM_CONTAINERS_USER_GUIDE.md` — tenant guide
