...
- `docs/architecture/BACKUP_COMPONENT_MODEL.md` — bundle layout + `meta.json` schema
- `docs/features/RESTORE_SPECIFICATION.md` — restore API + granularity (downstream consumer)
