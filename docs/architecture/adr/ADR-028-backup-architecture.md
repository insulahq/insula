...
CronJobs, and the implicit assumption that a PVC tarball alone suffices as a
client backup.
...
Simultaneously, `docs/features/RESTORE_SPECIFICATION.md` already specified
...
`meta.json` manifest. See `docs/architecture/BACKUP_COMPONENT_MODEL.md`.
