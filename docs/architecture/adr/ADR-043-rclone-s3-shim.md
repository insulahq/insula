...
**Status**: **ACCEPTED-EXTENDED 2026-05-20**, **NFS-AMENDED 2026-05-25** — the shim is adopted as the universal mediator for ALL platform backups, not just postgres + etcd. See BACKUP_ARCHITECTURE_RFC §13a for topology.
...
BACKUP_ARCHITECTURE_RFC §7 documents the hard constraint that some backup mechanisms only support S3-compatible APIs:
