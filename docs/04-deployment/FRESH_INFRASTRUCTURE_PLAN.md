...
|--------|-----------|------|----------|-------|
| **admin1.phoenix-host.net** | `46.224.122.58` | k3s + Management API + Admin Panel + Tenant Panel + Phase 1 Workloads | Hetzner (TBD location) | CX32 (4 vCPU, 8GB RAM, 80GB NVMe) |
...
- React 18 + Vite + TypeScript + shadcn/ui + Tailwind CSS
- Deployed as static site (nginx container)
- Public endpoint: `https://tenant.phoenix-host.net`
