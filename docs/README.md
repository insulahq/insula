...
- **Cluster network & firewall:** [operations/CLUSTER_NETWORK.md](operations/CLUSTER_NETWORK.md) · [operations/PLATFORM_DOMAIN_RENAME.md](operations/PLATFORM_DOMAIN_RENAME.md)
- **Backups & snapshots:** [operations/TENANT_BACKUP.md](operations/TENANT_BACKUP.md) · [operations/TENANT_SNAPSHOTS.md](operations/TENANT_SNAPSHOTS.md) · [architecture/BACKUP_COMPONENT_MODEL.md](architecture/BACKUP_COMPONENT_MODEL.md)
- **Migration:** [operations/PLESK_MIGRATION.md](operations/PLESK_MIGRATION.md)
