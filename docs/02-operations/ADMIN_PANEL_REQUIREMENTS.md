...
| `POST` | `/api/v1/admin/workload-repos/restore-default` | Restore the official default catalog repo (`https://github.com/insulahq/hosting-platform-workload-catalog`) |
