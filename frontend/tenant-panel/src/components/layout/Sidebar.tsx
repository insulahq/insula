...
export default function Sidebar({ open, onClose }: SidebarProps) {
  return (
    <>
      ...
      <aside
        className={clsx(
          'fixed inset-y-0 left-0 z-50 flex w-64 flex-col bg-linear-to-b from-brand-500 to-accent-500 dark:from-brand-900 dark:to-accent-700 transition-transform duration-200 lg:static lg:translate-x-0',
