...
export default function LogViewer({ deploymentId, tenantId: propTenantId }: LogViewerProps) {
  ...
  const staticLogs = useDeploymentLogs(tenantId ?? undefined, deploymentId, !streaming);
