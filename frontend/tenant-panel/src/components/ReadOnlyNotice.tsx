 ...
 * `tenant_user` accounts. The backend already rejects writes from
 * this role via `requireTenantRoleByMethod` middleware — this
 * notice explains why the buttons are missing.
 */
export default function ReadOnlyNotice({
  message = 'You have read-only access to this section. Only administrators can make changes. Contact a tenant admin to request changes.',
