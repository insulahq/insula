 ...
 *   - tenantStatus=suspended → red banner, destructive actions blocked
 *   - tenantStatus=archived → gray banner, read-only access
...
export default function LifecycleBanner() {
  ...
  const { tenantStatus, storageLifecycleState } = data;
