 ...
 * `GET /api/v1/tenants/:id/resource-metrics` and
 * `GET /api/v1/tenants/:id/resource-availability` but the tenant
 ...
 *
 * This new page gives tenants a permalink dashboard view of their
