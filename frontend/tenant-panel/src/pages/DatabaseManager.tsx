...
// No client-side password generator here either — see the note in
// DatabaseManagementModal.tsx. Database-user passwords are generated by the
// server and returned in the response; anything generated in the browser is
// never sent to the database and can only ever be displayed as a lie.
...
export default function DatabaseManager() {
  ...
  const handleCreateUser = useCallback(() => {
    ...
    createDbUser.mutate(
      ...
      {
        // Display the password the SERVER applied. This page previously showed
        // one generated in the browser and never sent to the database, so every
        // user created here had a different password than the one displayed.
        onSuccess: (res) => {
          setCreatedUserPassword(res.data.password);
