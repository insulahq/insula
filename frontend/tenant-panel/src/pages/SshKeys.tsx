...
export default function SshKeys() {
  ...
  const { data, isLoading } = useSshKeys(tenantId ?? undefined);
  const createKey = useCreateSshKey(tenantId ?? undefined);
  const updateKey = useUpdateSshKey(tenantId ?? undefined);
  const deleteKey = useDeleteSshKey(tenantId ?? undefined);
