...
export default function CronJobs() {
  ...
  const { data: response, isLoading, isError, error } = useCronJobs(tenantId ?? undefined);
  const createJob = useCreateCronJob(tenantId ?? undefined);
  const updateJob = useUpdateCronJob(tenantId ?? undefined);
