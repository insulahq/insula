...
describe('Domains Page', () => {
  ...
  it('renders domain list with name, status, and DNS mode', () => {
    mockedUseDomains.mockReturnValue({
      data: {
        data: [
          { id: '1', tenantId: 'c1', domainName: 'example.com', status: 'active', dnsMode: 'managed', sslAutoRenew: 1, createdAt: '2025-01-01T00:00:00Z' },
          { id: '2', tenantId: 'c1', domainName: 'test.org', status: 'pending', dnsMode: 'external', sslAutoRenew: 0, createdAt: '2025-02-01T00:00:00Z' },
        ],
  ...
  it('shows SSL auto-renew column values', () => {
    mockedUseDomains.mockReturnValue({
      data: {
        data: [
          { id: '1', tenantId: 'c1', domainName: 'ssl-yes.com', status: 'active', dnsMode: 'managed', sslAutoRenew: 1, createdAt: '2025-01-01T00:00:00Z' },
          { id: '2', tenantId: 'c1', domainName: 'ssl-no.com', status: 'active', dnsMode: 'managed', sslAutoRenew: 0, createdAt: '2025-02-01T00:00:00Z' },
        ],
        pagination: { total_count: 2, cursor: null, has_more: false, page_size: 20 },
      },
      isLoading: false,
