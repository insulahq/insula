 ...
 * moved to the sibling Web Defense page; the L4 enforcement toggle also
 * moved there as a top-of-page banner.
 *
 * 9 tabs remain:
    ...
    <div className="space-y-6">
      <header className="space-y-2">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-2xl font-semibold text-gray-900 dark:text-gray-100">Posture</h1>
        </div>
  ...
  return (
    <section className="space-y-4">
      ...
      <div className="text-xs text-gray-600 dark:text-gray-400">
        ...
        <Link to="/security/network-trust" className="text-brand-600 hover:underline dark:text-brand-400">Network Trust</Link>{' '}
        page.
      </div>
    </section>
  );
