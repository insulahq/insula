...
function MigrationLegs({ migration }: { readonly migration: PleskMigrationResponse }) {
  ...
  const order = ['preflight', 'domains', 'email', 'databases', 'content'];
