          ...
          {isMaster ? (
            ...
            <>
              <button
                type="button"
                disabled
                title="Stalwart snapshot-restore wizard is not built yet. To preserve DKIM + mailbox messages, restore Stalwart from a snapshot manually using scripts/mail-stack-consolidate.sh."
