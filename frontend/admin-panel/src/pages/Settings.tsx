...
import { Settings as SettingsIcon, Server, Shield, Globe, CreditCard, ChevronRight, Loader2, HardDrive, Users, Heart, Download, RefreshCw, CheckCircle, AlertCircle, Cpu, Container, X, Network, GitBranch, Workflow } from 'lucide-react';
...
export default function Settings() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-5 shadow-sm" data-testid="platform-config-section">
        ...
        <div className="mt-4 flex justify-end">
          <button
            ...
            className="inline-flex items-center gap-2 rounded-lg border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 px-3 py-1.5 text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors"
      ...
      {/* Email System moved to its own top-level sidebar group on
          2026-05-26 (Email → Domains & Relays / Settings / Operations).
          Settings tile retired here — operators navigate via the
          sidebar; legacy /settings/email redirects in App.tsx. */}
...
/**
 * Modal showing the container images + resolved tags currently running
