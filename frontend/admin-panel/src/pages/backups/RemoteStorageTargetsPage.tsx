    ...
    <div className="space-y-6 p-6">
      <header className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <Cloud size={28} className="text-gray-700 dark:text-gray-300" />
          <div>
            <h1
              className="text-2xl font-semibold text-gray-900 dark:text-gray-100"
              data-testid="remote-storage-targets-heading"
            >
              Remote Storage Targets
            </h1>
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Off-cluster destinations for backup uploads (S3, SFTP, CIFS). Bind each backup class to a target at{' '}
              <Link to="/backups/system" className="font-medium text-brand-600 hover:underline dark:text-brand-300">
                /backups/&lt;class&gt;
              </Link>
              .
            </p>
