...
const accentColors = {
  brand: 'border-l-brand-500 bg-brand-50/50 dark:border-l-brand-400 dark:bg-brand-950/30',
...
export default function StatCard({
  ...
  return (
    <div
      className={clsx(
        'rounded-xl border border-gray-200 border-l-4 bg-white p-5 shadow-sm transition-shadow hover:shadow-md dark:border-gray-700 dark:bg-gray-800',
        accentColors[accent],
      )}
